...
CREATE TABLE public.prevision (
	id_prevision smallint NOT NULL GENERATED ALWAYS AS IDENTITY ,
	...
	humidite smallint,
	pression_athmospherique smallint,
	CONSTRAINT prevision_pk PRIMARY KEY (id_prevision)

);
-- ddl-end --
COMMENT ON COLUMN public.prevision.direction_vent IS E'en degres';
-- ddl-end --
COMMENT ON COLUMN public.prevision.force_vent IS E'en km/h\n        decimal longueur 5 pour 3 chiffres avant la virgule et 2 chiffres apres la virgule';
-- ddl-end --
COMMENT ON COLUMN public.prevision.last_update IS E'verifie si l info a moins de 24 heures';
-- ddl-end --
